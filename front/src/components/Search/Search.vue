    ...
    <section class="search">
        <div class="search__container container">
            <div class="search__first-line">
                <a href="#"><img class="search__logo logo" src="@/assets/img/logo.png" alt="logo"></a>
                ...
                <div class="search__contact">
                    <div class="search__phone-box">
                        ...
                        <a class="search__phone-link" href=""><img class="search__phone-icon" src="@/assets/img/phone.svg" alt=""></a>
                    </div>
                    <div class="search__phone-contacts">
                        <p class="search__number text">+38 (067) 115 00 58</p>
                ...
                <div class="search__bag-block">
                    <a class="search__bag-link" href=""><img class="search__icon bag-icon" src="@/assets/img/bag.svg" alt="bag"></a>
