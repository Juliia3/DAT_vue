...
<template>
  <div class="page-wrapper">
    ...
    <section class="about-us">
      <img class="about-us__orange circle-right circle" src="@/assets/img/orange-circle.png" alt="orange">
      <img class="about-us__orange circle-left circle" src="@/assets/img/orange-circle.png" alt="orange">
